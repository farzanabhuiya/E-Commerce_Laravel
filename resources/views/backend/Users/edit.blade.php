...
@section('backend')
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$user->password}}"  type="text" name="password" id="password"  class="form-control" placeholder="Password">	
                                </div>
                            </div>	
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$user->mobile}}" type="text" name="mobile" id="slug"  class="form-control" placeholder="Phone">	
                                </div>
                            </div>	
                ...
                <div class="pb-5 pt-3">
                    <button class="{{route('User.index')}}">Update</button>
