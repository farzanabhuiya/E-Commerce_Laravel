					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{route('Subcategorie.index')}}" class="btn btn-primary">New Sub Category</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
						...
						<div class="card">
							<div class="card-header">
								...
								<div class="card-title">
									<button type="button" onclick="window.location.href='{{route('Subcategorie.index')}}'" class="btn btn-primary bt-sm">Reset</button>
								   </div>
